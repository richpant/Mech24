...
public class Robot extends TimedRobot {
  ...
  private static final int leadDeviceID = 4;
...
//Arm
  ...
  public void robotInit() {
    ...
    m_stick1 = new Joystick(kJoystickChannel1);
    m_stick2  = new Joystick(kJoystickChannel2);
...
SmartDashboard.putNumber("LimelightArea", area);
    ...
    m_robotDrive.driveCartesian(-m_stick1.getY(), -m_stick1.getX(), -m_stick1.getZ());
    //should drive two arm motors together?
    m_armLeadMotor.set(m_stick2.getY());
    //if for intake in and out
    if(m_stick2.getRawButton(4)){
      m_intake.set(1);
    }else{
      m_intake.set(0);
    }
